"""
Django settings for equifax_creditguard_45657 project.
...
ROOT_URLCONF = 'equifax_creditguard_45657.urls'
...
WSGI_APPLICATION = 'equifax_creditguard_45657.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "equifax_creditguard_45657 API",
    "DESCRIPTION": "API documentation for equifax_creditguard_45657 App",
    "VERSION": "v1",
}
